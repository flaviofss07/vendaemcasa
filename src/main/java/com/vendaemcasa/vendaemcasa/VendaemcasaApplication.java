...
import com.vendaemcasa.vendaemcasa.domain.*;
import com.vendaemcasa.vendaemcasa.domain.enums.EstadoPagamento;
import com.vendaemcasa.vendaemcasa.domain.enums.TipoCliente;
import com.vendaemcasa.vendaemcasa.repositories.*;
...
public class VendaemcasaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception{
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2020 15:36"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/09/2020 19:36"), cli1, e2);
